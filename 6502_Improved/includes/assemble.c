    ...
    while (reg->PC < ROM) {
        ...
        switch (monitorMem[reg->PC]) {
            ...
            case 0xA1:
                ...
                break;
            case 0xB1:
                reg->A = monitorMem[_indirectY(reg,monitorMem)];
                break;
            //STA
            case 0x85:
                reg->PC++;
            ...
            case 0xD9:
                ...
                break;
            case 0xC1:
                _cmp_instruction(reg, &reg->A, monitorMem[_indirectX(reg,monitorMem)]);
                break;
            case 0xD1:
                _cmp_instruction(reg, &reg->A, monitorMem[_indirectY(reg,monitorMem)]);
                break;
            //CPX
            case 0xE0:
                reg->PC++;
